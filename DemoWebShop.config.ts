...
const config = {
  ...
  // @ts-ignore
  //globalSetup: require.resolve('./OrangeHRM_Login_Setup'),  // <--- points to global-setup
  //globalSetup: require.resolve('./WebOrder_Login_Setup'),// <--- points to global-setup
  ...
  /* reporter: [
    ['playwright-smart-reporter', {
      outputFile: 'ZeroBank_Test_Report.html',
