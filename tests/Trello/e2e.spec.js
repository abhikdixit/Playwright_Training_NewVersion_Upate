...
test.describe("Automation tests for trello using playwright", () => {
  let  username;
  let page = Page;
  let login = LoginPage;
  let home = HomePage;
  ...
  test.only("Should be able to create a new board", async () => {
  ...
  test("Should be able to close a board", async () => {
    const boardname = "playwright";
  ...
  test("Should be able to reopen a closed board", async () => {
    const boardname = "playwright";
    // go to Team Boards under Trello Workspace
    await home.getTeamsBoards();
  ...
  test("Should be able to add a list to a board", async () => {
    const boardname = "playwright";
    let count = 0;
  ...
  test("Should be able to add a cards to a list", async () => {
  ...
  test("Should be able to move cards from one list to another", async () => {
    const boardname = "playwright";
  ...
  test("Should be able to update a card description", async () => {
    const boardname = "playwright";
  ...
  test("Should be able add a checklist to a card", async () => {
    const boardname = "playwright";
  ...
  test("Should be able to update the card checklist", async () => {
    const boardname = "playwright";
  ...
  test("Should clean up the environment", async () => {
    const boardname = "playwright";
