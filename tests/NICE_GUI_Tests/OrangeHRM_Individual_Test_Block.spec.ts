...
test('Login and Verify Changes', async ({ page }) => {
...
test('Create User and Verify Changes', async ({ page }) => {
...
test('Update User and Verify Changes', async ({ page }) => {
...
test('Delete User and Verify Deletion', async ({ page }) => {
