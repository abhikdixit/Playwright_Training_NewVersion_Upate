...
// Update the order and Verify that record got updated

await expect(page.locator("//td[normalize-space()='Dixit1']")).toHaveText("Dixit1")

  // Update the Order details

  await page.locator("//td[normalize-space()='Dixit1']//following-sibling::td/input").click();
  ...
  await expect(page.locator("//td[normalize-space()='Dixit1']//following-sibling::td[text()='Delhi']")).toHaveText("Delhi")
